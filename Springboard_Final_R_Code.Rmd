...
(mse <- mean((test$Earnings - predict(model, test))^2)) #MSE is really large
...
(mse1 <- mean((test$Earnings - predict(model1, test))^2)) #MSE is really large
...
(mse2 <- mean((test$Earnings - predict(model2, test))^2)) #MSE is really large
...
(mse3 <- mean((test$Earnings - predict(model3, test))^2)) #MSE is really large
...
(mse4 <- mean((test$Earnings - predict(model4, test))^2)) #MSE is really large
...
(mse5 <- mean((test$Earnings - predict(model5, test))^2)) #MSE is really large
